  ...
  return (
    <div className="album-detail-view" style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
      ...
      <div className="album-header" style={{ display: 'flex', gap: '24px', alignItems: 'flex-end' }}>
        <div style={{ width: '200px', height: '200px', backgroundColor: 'var(--bg-primary)', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 8px 24px rgba(0,0,0,0.5)' }}>
